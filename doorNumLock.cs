...
public class doorNumLock : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (target != null)
        {
            if (Input.GetMouseButtonUp(0))
            {
                ...
                {
                    if (target.transform.parent.name == "goOutDoorLock")
                    {
                        mode = 1;
                ...
                {
                    if (target.transform.parent.name == "goOutDoorLock" || mode == 1)
                    {
    ...
    private void success()
    {
        ...
        {
            GameObject.Find("goOutDoorLock").SetActive(false);
            goOutDoor.transform.GetComponent<Animation>().Play();
          // goOutDoor.transform.GetComponent<AudioSource>().Play();
        }
        else if (mode == 3)
