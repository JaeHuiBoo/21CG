...
public class ElectricWavePuzzle : MonoBehaviour
{
    ...
    public GameObject monitor1gameObject;
    public GameObject monitor2gameObject;
    public GameObject elecSuccess;
    public GameObject projecterSuccess;
    ...
    void Start()
    {
        ...
        projecterSuccess.SetActive(false);
        SetUp();
    }
    ...
    public void CheckComplete()
    {
        ...
        if (complete1 && complete2)
        {
            ...
            /*
            this.transform.GetComponent<AudioSource>().clip = Resources.Load("Audios/success") as AudioClip;
            this.transform.GetComponent<AudioSource>().loop = false;
            this.transform.GetComponent<AudioSource>().Play();
            */
            monitor1gameObject.SetActive(false);
            monitor2gameObject.SetActive(false);
            elecSuccess.SetActive(true);
            projecterSuccess.SetActive(true);
        }
    }
}
